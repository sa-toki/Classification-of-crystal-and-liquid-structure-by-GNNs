...
The implementation of the graph neural network, Graph convolutional network(GCN) and Tensor embedded atom network(TeaNet), used in the paper can be implemented by referring to our paper and the original paper[1,2].
